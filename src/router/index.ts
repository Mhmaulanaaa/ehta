...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      ...
      // },
      {
        path: "/master-user",
        name: "masteruser",
        component: () => import("@/views/hta/MasterUser.vue"),
        meta: {
      ...
      {
        path: "/informasi-verifikator",
        name: "informasi-verifikator",
        component: () => import("@/views/hta/InformasiVerifikator.vue"),
        meta: {
          pageTitle: "Pengajuan (Verifikator)",
          breadcrumbs: ["Pengajuan(Verifikator)"],
        },
      },
      {
        path: "/informasi-reviewer",
        name: "informasi-reviewer",
        component: () => import("@/views/hta/InformasiReviewer.vue"),
        meta: {
          pageTitle: "Pengajuan (Reviewer)",
          breadcrumbs: ["Pengajuan(Reviewer)"],
        },
      },
      {
        path: "/informasi-kepalaverifikator",
        name: "informasi-kepalaverifikator",
        component: () => import("@/views/hta/InformasiKepalaVerifikator.vue"),
        meta: {
          pageTitle: "Pengajuan (Kepala Verifikator)",
          breadcrumbs: ["Pengajuan(Kepala Verifikator)"],
        },
      },
      {
        path: "/informasi-viewer",
        name: "informasi-viewer",
        component: () => import("@/views/hta/InformasiViewer.vue"),
        meta: {
          pageTitle: "Pengajuan (Viewer)",
          breadcrumbs: ["Pengajuan(Viewer)"],
        },
      },
      {
        path: "/informasi-pembuatandokumen",
        name: "informasi-pembuatandokumen",
        component: () => import("@/views/hta/InformasiDokumenVerifikator.vue"),
        meta: {
          pageTitle: "Pembuatan Dokumen HTA (Verifikator)",
          breadcrumbs: ["Pembuatan Dokumen HTA (Verifikator)"],
        },
      },
      // Informasi e-Hta
      {
        path: "/laporan",
        name: "laporan",
        component: () => import("@/views/hta/Laporan.vue"),
        meta: {
          pageTitle: "Laporan",
          breadcrumbs: ["Laporan"],
        },
      ...
      // Laporan e-Hta
      {
        path: "/transaksi-atk",
        name: "transaksi-atk",
        component: () => import("@/views/hta/TransaksiPengajuanATK.vue"),
        meta: {
          pageTitle: "Transaksi A/TK",
          breadcrumbs: ["Transaksi A/TK"],
        },
      },
      {
        path: "/transaksi-obat",
        name: "transaksi-obat",
        component: () => import("@/views/hta/TransaksiPengajuanObat.vue"),
        meta: {
          pageTitle: "Transaksi Obat",
          breadcrumbs: ["Transaksi Obat"],
        },
      },
      {
        path: "/revisi-dokumen",
        name: "transaksi-revisi-dokumen",
        component: () => import("@/views/hta/TransaksiRevisiDokumen.vue"),
        meta: {
          pageTitle: "Revisi Dokumen PPK",
          breadcrumbs: ["Revisi Dokumen PPK"],
        },
      },
